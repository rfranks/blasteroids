...
exports.publish = function (taffyData, opts, tutorials) {
  ...
  view = new template.Template(templatePath + '/templates');
  ...
  for (var longname in helper.longnameToUrl) {
    if (hasOwnProp.call(helper.longnameToUrl, longname)) {
      ...
      if (myClasses.length) {
        generate('class', '<i class="glyphicon glyphicon-object-align-vertical"></i>&nbsp;Class', myClasses, helper.longnameToUrl[longname]);
      }
      ...
      if (myModules.length) {
        generate('module', '<i class="glyphicon glyphicon-object-align-left"></i>&nbsp;Module', myModules, helper.longnameToUrl[longname]);
      }
      ...
      if (myNamespaces.length) {
        generate('namespace', '<i class="glyphicon glyphicon-book"></i>&nbsp;Namespace', myNamespaces, helper.longnameToUrl[longname]);
      }
      ...
      if (myMixins.length) {
        generate('mixin', '<i class="glyphicon glyphicon-random">&nbsp;</i>Mixin', myMixins, helper.longnameToUrl[longname]);
      }
      ...
      if (myInterfaces.length) {
        generate('interface', '<i class="glyphicon glyphicon-log-in"></i>&nbsp;Interface', myInterfaces, helper.longnameToUrl[longname]);
      }
      ...
      if (myExternals.length) {
        generate('external', '<i class="glyphicon glyphicon-import"></i>&nbsp;External', myExternals, helper.longnameToUrl[longname]);
      }
    }
  }
  ...
  if (searchEnabled) {
    generateQuickTextSearch(templatePath + '/templates', searchableDocuments, navOptions);
  }
};
